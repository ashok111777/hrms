...
@Component({
  selector: 'app-probation-report',
  templateUrl: './probation-report.component.html',
  styleUrls: ['./probation-report.component.scss']
})
export class ProbationReportComponent {
  ...
  ///api/web/v1/probation/complation/report?startDate=2023-11-03&endDate=2023-11-03
  GetData(mode: string) {
    ...
    if (this.EmployeeData.valid) {
      this.restApi.getService('api/web/v1/probation/complation/report' + '?startDate=' + startDate + '&endDate=' + endDate).subscribe((resp: any) => {
  ...
  async generatePDF(employeeList: any[], startDate: any, endDate: any) {
    ...
    const headerName = ['Emp Id', 'Name', 'Team Name', 'Designation', 'Doj', 'Doc', 'probationExtensionDate',];
    ...
    const docDefinition: any = {
      ...
      content: [
        ...
        { text: 'Probation Report', style: 'header' },
        {
          alignment: 'justify',
          columns: [
            {
